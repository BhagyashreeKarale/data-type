...
# Integer data type has a simple numeric value which is either positive or 
# negative whose length is unlimited.
...
# Output :- -14326
# In this example, we have seen how we have taken a negative value in a variable named b, 
